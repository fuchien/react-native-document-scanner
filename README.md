...
# `@fuchien/react-native-document-scanner`
...
project(':openCVLibrary310').projectDir = new File(rootProject.projectDir,'../node_modules/@fuchien/react-native-document-scanner/android/openCVLibrary310')
```
...
import DocumentScanner from "@fuchien/react-native-document-scanner"
  ...
  return (
    <View>
      <DocumentScanner
        ...
        onDocumentScannerTaken={handleonDocumentScannerTaken}
...
| :--------------------- | :----: | :------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| onDocumentScannerTaken | `data` | `object` | Returns the captured image in an object `{ croppedImage: ('URI or BASE64 string'), initialImage: 'URI or BASE64 string', rectangleCoordinates[only iOS]: 'object of coordinates' }` |
